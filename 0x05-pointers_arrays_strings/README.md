...
In this project I provided solutions to tasks given and cover the learning objectives. It was a C programing task that allowed me to express my level of understanding in Data structure, Arrays, Pointers and strings.
